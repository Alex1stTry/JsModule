...
form.onsubmit = function (e) {
    ...
    let userSur = this.surname.value
    let userAge = this.age.value
    let user = {name: userName, surname: userSur, age: userAge}
    let userDiv = document.createElement('div');
    userDiv.innerText = `${userName},${userSur} ${user.age}`
...
//
//         title.innerText = `district : ${obj.title}`;
//         type.innerText = `type : ${obj.type}`;
//
//         block.append(title, type);
//         array.push(block);
//     }
//     mainBlock.replaceChildren(...array)
// }
//
// switcher(page, limit)
// previousButton.addEventListener('click', () => switcher(page -= 1, limit))
// nextButton.addEventListener('click', () => switcher(page += 1, limit))
// - Створити довільний елемент з id = text та створити кнопку.Використовуючи JavaScript, зробіть так, щоб при натисканні на кнопку зникав елемент з id="text".
let focus = document.getElementById('text');
let magicButton = document.getElementById('magic');
focus.innerText = 'focus'
focus.style.background = 'silver'
focus.style.width = '200px'
magicButton.innerText = 'magicButton'
